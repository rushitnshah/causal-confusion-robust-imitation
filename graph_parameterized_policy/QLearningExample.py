...
max_iteration = 100000 # max_iteration
...
filename = "learned_policy_iter_"+str(max_iteration)+"_"+str(date_obj.year)+"_"+str(date_obj.month)+"_"+str(date_obj.day)+"_"+str(date_obj.hour)+"_"+str(date_obj.minute)
np.save(filename,solution_policy)
